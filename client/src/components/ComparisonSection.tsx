            ...
            <table className="w-full text-sm text-left">
              <thead className="bg-muted/50 text-muted-foreground font-medium">
                <tr>
                  ...
                  <th className="p-4 text-[#FB923C]">Ersparnis</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-border">
                <tr className="hover:bg-muted/20 transition-colors">
                  ...
                  <td className="p-4 font-bold text-[#FB923C]">20 €</td>
                </tr>
                <tr className="hover:bg-muted/20 transition-colors">
                  <td className="p-4 font-bold text-foreground">
                    Zuhause Basis
                  ...
                  <td className="p-4 font-bold text-[#FB923C]">38 €</td>
                </tr>
                <tr className="hover:bg-muted/20 transition-colors bg-primary/5">
                  ...
                  <td className="p-4 font-bold text-[#FB923C]">78 €</td>
                </tr>
              </tbody>
            </table>
          </div>
