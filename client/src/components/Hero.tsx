          ...
          <div className="col-span-full text-center space-y-12">
            <div className="space-y-6 max-w-3xl mx-auto">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Tech Hilfe Pro ist Ihr zuverlässiger Ansprechpartner für alle
                Technikfragen. Ob schnelle PC-Hilfe für Privatkunden oder
                professionelle Managed Services für KMU – wir sind für Sie da.
              </p>
            </div>
                ...
                <div className="space-y-6 relative z-10">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground leading-relaxed group-hover:text-foreground/80 transition-colors">
                      Schnelle Hilfe bei PC-Problemen, WLAN, Smart Home und
                      mehr. Fernwartung oder Vor-Ort-Service.
                    </p>
                  </div>
                  <Button
                    className="w-full btn-outline group-hover:bg-primary group-hover:text-primary-foreground group-hover:border-primary transition-all"
                    asChild
                  >
              ...
              <div className="msp-card p-8 text-left hover:bg-secondary/30 transition-all duration-300 group relative overflow-hidden">
                <div className="space-y-6 relative z-10">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground leading-relaxed group-hover:text-foreground/80 transition-colors">
                      Managed IT, NIS2-Compliance, Backups und Sicherheit für
                      KMU. Ihre externe IT-Abteilung.
                    </p>
                  </div>
                  <Button
                    className="w-full btn-outline group-hover:bg-primary group-hover:text-primary-foreground group-hover:border-primary transition-all"
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  <h3 className="text-2xl lg:text-3xl font-bold text-foreground">
                    Was macht Tech Hilfe Pro anders?
                  </h3>
                  <p className="text-muted-foreground leading-relaxed">
                    Wir kombinieren schnelle, verständliche PC-Hilfe für Zuhause
                    mit professioneller, dokumentierter IT-Betreuung für kleine
                    Unternehmen. Alles aus einer Hand, lokal in Köln & Neuss –
                    mit Fokus auf Sicherheit, Transparenz und
                    Fördermöglichkeiten.
                  </p>
                </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        ...
                        wenigen Minuten, wo Sie stehen – ganz ohne Fachwissen.
                      </p>
                    </div>
